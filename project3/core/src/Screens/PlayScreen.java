...
public class PlayScreen implements Screen {
	...
	public void render(float delta) {
		...
		case 0:
			game.sb.draw(switchBlueIcon, 150 / Pyramid.PPM, 10 / Pyramid.PPM, 50 / Pyramid.PPM, 50 / Pyramid.PPM);
			break;
		case 1:
			game.sb.draw(switchPinkIcon, 150 / Pyramid.PPM, 10 / Pyramid.PPM, 50 / Pyramid.PPM, 50 / Pyramid.PPM);
			break;
		}
		game.sb.end();
