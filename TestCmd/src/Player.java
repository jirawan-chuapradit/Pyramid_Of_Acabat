...
public class Player {
	...
	private void calculateCorners(double x, double y) {
		...
		System.out.println("leftTile_check====    "+ leftTile);
		System.out.println("rightTile_check====    "+ rightTile);
		System.out.println("topTile_check====    "+ topTile);
		System.out.println("bottomTile_chcek====    "+ bottomTile);
	}
	...
	public void update() {
		...
		if (dy < 0) {
			if (topLeft || topRight) {
				...
				System.out.println("tempy topLeft === "+ tempy);
			} else {
				tempy += dy;
			}
		}
		if (dy > 0) {
			if (bottomLeft || bottomRight) {
				...
				System.out.println("tempy  bottomLeft === "+ tempy);
			} else {
				tempy += dy;
			}
		}
